# ============================================================================
# Integration Environment - Terraform Backend Bootstrap Configuration
# ============================================================================
# This file contains the configuration values for the integration environment
...
state_bucket_name = "hyperswitch-integ-terraform-state"

# Allow destruction of the bucket (can be recreated if needed)
...
dynamodb_table_name = "hyperswitch-integ-terraform-state-lock"

# Billing mode (PAY_PER_REQUEST is cost-effective for state locking)
dynamodb_billing_mode = "PAY_PER_REQUEST"

# Point-in-time recovery (disabled for integ to save costs)
