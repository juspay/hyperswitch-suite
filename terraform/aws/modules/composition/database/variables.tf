...
variable "engine_mode" {
  ...
  validation {
    condition     = var.engine_mode == null || contains(["global", "parallelquery", "provisioned", "serverless", ""], var.engine_mode == null ? "" : var.engine_mode)
...
variable "engine_lifecycle_support" {
  ...
  validation {
    condition     = var.engine_lifecycle_support == null || contains(["open-source-rds-extended-support", "open-source-rds-extended-support-disabled"], var.engine_lifecycle_support == null ? "" : var.engine_lifecycle_support)
...
variable "cluster_scalability_type" {
  ...
  validation {
    condition     = var.cluster_scalability_type == null || contains(["limitless", "standard"], var.cluster_scalability_type == null ? "" : var.cluster_scalability_type)
...
variable "network_type" {
  ...
  validation {
    condition     = var.network_type == null || contains(["IPV4", "DUAL"], var.network_type == null ? "" : var.network_type)
...
variable "database_insights_mode" {
  ...
  validation {
    condition     = var.database_insights_mode == null || contains(["standard", "advanced"], var.database_insights_mode == null ? "" : var.database_insights_mode)
