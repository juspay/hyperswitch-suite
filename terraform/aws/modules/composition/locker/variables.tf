...
variable "additional_policy_arns" {
  description = "List of additional IAM policy ARNs to attach to the Locker IAM role (e.g., AmazonSSMManagedInstanceCore for SSM access)"
  type        = list(string)
  default     = []
}
...
variable "database_config" {
  ...
  type = object({
    ...
    master_password_secretsmanager_secret_id  = optional(string, null)
    master_password_secretsmanager_secret_key = optional(string, null)
