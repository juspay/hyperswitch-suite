...
| <a name="module_eks"></a> [eks](#module\_eks) | ../../base/eks | n/a |
...
| <a name="input_default_node_os"></a> [default\_node\_os](#input\_default\_node\_os) | OS type for node group AMIs. Must be explicitly set. Options: 'al2023' (Amazon Linux 2023, MIME multipart YAML via nodeadm) or 'bottlerocket' (Bottlerocket, TOML format). Individual node groups can override this via the 'os\_type' field. | `string` | `"al2023"` | no |
