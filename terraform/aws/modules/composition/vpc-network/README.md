...
| <a name="module_custom_vpc_endpoints"></a> [custom\_vpc\_endpoints](#module\_custom\_vpc\_endpoints) | ../../base/vpc-endpoint | n/a |
...
| <a name="input_custom_vpc_endpoints"></a> [custom\_vpc\_endpoints](#input\_custom\_vpc\_endpoints) | Map of custom PrivateLink VPC endpoints to create with arbitrary service names | <pre>map(object({<br/>    service_name        = string<br/>    private_dns_enabled = optional(bool, true)<br/>  }))</pre> | `{}` | no |
...
| <a name="output_custom_vpc_endpoint_ids"></a> [custom\_vpc\_endpoint\_ids](#output\_custom\_vpc\_endpoint\_ids) | Map of Custom VPC Endpoint IDs |
