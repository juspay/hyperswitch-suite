...
# =========================================================================
output "role_arn" {
  description = "ARN of the IAM role for Wazuh application"
  value       = aws_iam_role.this.arn
}

output "role_name" {
  description = "Name of the IAM role for Wazuh application"
  value       = aws_iam_role.this.name
}

output "role_id" {
  description = "ID of the IAM role for Wazuh application"
...
output "cloudwatch_logs_enabled" {
  description = "Whether CloudWatch Logs access policy is enabled"
  value       = local.cloudwatch_logs_enabled
}
...
output "cloudwatch_logs_policy_name" {
  ...
  value       = local.cloudwatch_logs_enabled ? aws_iam_role_policy.cloudwatch_logs[0].name : null
}
