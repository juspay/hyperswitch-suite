...
variable "s3" {
  description = "S3 bucket configuration for Revenue Recovery storage. Set to {} to disable. Set create=true to create bucket, or create=false with bucket_arn to use existing."
  type = object({
