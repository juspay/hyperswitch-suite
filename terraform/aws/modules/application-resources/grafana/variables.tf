...
variable "host_domains" {
  description = "Map of environment names to host domains for grafana. Example: { integ = 'integ.example.com', sandbox = 'sandbox.example.com' }"
  type        = map(string)
  default     = {}
}
...
variable "create_database" {
  description = "Whether to create a database for Grafana"
  type        = bool
  default     = false
}
