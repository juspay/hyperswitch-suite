module "database" {
  ...
  master_password_secretsmanager_secret_id  = var.database_config.master_password_secretsmanager_secret_id
  master_password_secretsmanager_secret_key = var.database_config.master_password_secretsmanager_secret_key
  ...
  security_group_description                = var.database_config.security_group_description != null ? var.database_config.security_group_description : "Security group for Superposition database"
