locals {
  ...
  # ============================================================================
  # S3 Permissions Policy for Loki
  # ============================================================================
  # This policy grants Loki the necessary permissions to read/write logs to S3
    ...
    Statement = [
      {
        ...
        Resource = [
          "arn:aws:s3:::${var.s3_bucket_name != null ? var.s3_bucket_name : "hs-${var.environment}-loki-logs-storage"}",
          "arn:aws:s3:::${var.s3_bucket_name != null ? var.s3_bucket_name : "hs-${var.environment}-loki-logs-storage"}/*"
        ]
      }
    ]
