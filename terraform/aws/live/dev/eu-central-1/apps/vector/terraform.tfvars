...
# ============================================================================
# S3 Bucket Configuration for Vector Logging Logs
# ============================================================================

# Set to true to create S3 bucket for Vector Logging logs storage
create_s3_bucket = true

# Optional: Custom bucket name (if null, auto-generated as hs-{env}-vector-logging-logs-storage)
# s3_bucket_name = "hs-dev-vector-logging-logs-storage"
