...
# {{eks_cluster_name}}           - Replaced with "integ-hyperswitch-cluster"
...
create_lb           = true  # Set to false to use existing ALB
create_target_group = true  # Set to false to use existing target group

# Required when using existing ALB (create_lb = false)
# TODO: Replace with your actual external ALB ARN and security group ID
# existing_lb_arn               = "arn:aws:elasticloadbalancing:eu-central-1:xxxxx:loadbalancer/app/external-lb/xxxxx"
# existing_lb_security_group_id = "sg-xxxxx"  # Security group ID (not ARN) of existing external ALB

# Optional: Only needed if create_target_group = false (currently creating new target group)
# existing_tg_arn = "arn:aws:elasticloadbalancing:eu-central-1:xxxxx:targetgroup/your-envoy-tg/xxxxx"
