...
#
# Units are consumed by immutable git ref (unit/aws/<name>-vX.Y.Z-v<rev>),
# except application-stack/eks-01, which has no versioned module tag yet and
# is still fetched by local path.
# =============================================================================
